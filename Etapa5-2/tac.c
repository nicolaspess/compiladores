...
TAC* tacPrintSingle(TAC* tac) {
	...
	switch(tac->type) {
		...
		case TAC_VALUE_ASSIGNMENT:	fprintf(stderr, "TAC_VALUE_ASSIGNMENT");	break;
...
TAC* generateCode(ASTREE* node) {
	...
	switch(node->type) {
		...
		case ASTREE_ADD: 	result = makeBinOp(TAC_ADD,sonCode[0],sonCode[1]);	break;
		case ASTREE_SUB: 	result = makeBinOp(TAC_SUB,sonCode[0],sonCode[1]);	break;
		case ASTREE_MULT:	result = makeBinOp(TAC_MULT,sonCode[0],sonCode[1]);	break;
		case ASTREE_DIV:	result = makeBinOp(TAC_DIV,sonCode[0],sonCode[1]);	break;

		case ASTREE_NOT:	result = makeBinOp(TAC_NOT,sonCode[0],sonCode[1]);	break;
		case ASTREE_OR:	result = makeBinOp(TAC_OR,sonCode[0],sonCode[1]);	break;
		case ASTREE_AND:	result = makeBinOp(TAC_AND,sonCode[0],sonCode[1]);	break;
		case ASTREE_NEQ:	result = makeBinOp(TAC_NEQ,sonCode[0],sonCode[1]);	break;
		case ASTREE_EQ:			result = makeBinOp(TAC_EQ,sonCode[0],sonCode[1]);			break;
		case ASTREE_GREATER_EQ:	result = makeBinOp(TAC_GREATER_EQ,sonCode[0],sonCode[1]);	break;
		case ASTREE_LESS_EQ:		result = makeBinOp(TAC_LESS_EQ,sonCode[0],sonCode[1]);		break;
		case ASTREE_LESS:			result = makeBinOp(TAC_LESS,sonCode[0],sonCode[1]);			break;
		case ASTREE_GREATER:		result = makeBinOp(TAC_GREATER,sonCode[0],sonCode[1]);		break;
